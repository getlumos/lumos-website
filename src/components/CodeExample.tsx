...
{`interface UserAccount {
  ...
  created_at: number;
                ...
                <div className="p-4 rounded-lg bg-muted/50 border border-border">
                  <div className="text-muted-foreground mb-2">// Rust (manually synchronized)</div>
                  <pre className="text-foreground font-mono text-xs leading-relaxed overflow-x-auto">
{`#[account]
pub struct UserAccount {
    pub pubkey: Pubkey,
    pub authority: Pubkey,
    pub balance: u64, // ⚠️ Type mismatch!
    pub created_at: i64,
}`}
                  </pre>
                </div>
                ...
                <div className="flex items-start gap-2 p-3 rounded-lg bg-destructive/10 border border-destructive/30">
                  ...
                  <div className="text-xs text-destructive">
                    Manual synchronization required • Runtime errors • Time-consuming maintenance
                  </div>
                </div>
              </div>
            </div>
          ...
          <Card className="p-6 bg-card border-primary/30">
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-sm">
                <div className="p-4 rounded-lg bg-muted/50 border border-border">
                  <div className="text-muted-foreground mb-2">// TypeScript (source of truth)</div>
                  <pre className="text-foreground font-mono text-xs leading-relaxed overflow-x-auto">
{`interface UserAccount {
  pubkey: PublicKey;
  authority: PublicKey;
  ...
  created_at: number;
                ...
                <div className="p-4 rounded-lg bg-primary/5 border border-primary/30">
                  <div className="text-primary mb-2">// Rust (auto-generated by Lumos) ✨</div>
                  <pre className="text-foreground font-mono text-xs leading-relaxed overflow-x-auto">
{`#[account]
pub struct UserAccount {
    pub pubkey: Pubkey,
    pub authority: Pubkey,
    pub balance: u64, // ✅ Perfectly matched!
    pub created_at: i64,
}`}
                  </pre>
                </div>
                ...
                <div className="flex items-start gap-2 p-3 rounded-lg bg-primary/10 border border-primary/30">
                  ...
                  <div className="text-xs text-primary">
                    Automatic synchronization • Type-safe • Zero maintenance overhead
                  </div>
                </div>
              </div>
            </div>
